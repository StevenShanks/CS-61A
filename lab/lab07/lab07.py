...
def make_glookup(class_assignments):
    ...
    0.8913043478260869
    """
    total_credit, credit_sofar = 0, 0
    def percentage(assignment, credit):
        nonlocal total_credit, credit_sofar
        total_credit += class_assignments[assignment]
        credit_sofar += credit
        return credit_sofar / total_credit
    return percentage
